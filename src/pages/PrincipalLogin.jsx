...
import { Box, Card, CardContent, Typography, TextField, Button, InputAdornment, IconButton, Alert, Chip, Divider, } from '@mui/material';
      ...
      <Box sx={{
        ...
        <Box>
          ...
          <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mt: 4 }}>
            {['Live Attendance', 'Teacher Overview', 'Event Management', 'SF2 Reports'].map(f => (<Chip key={f} label={f} size="small" sx={{
        ...
        <Box sx={{ width: '100%', maxWidth: 400, mx: { xs: 1, sm: 'auto' }, }}>  
          ...
          <Card sx={{
            ...
            letterSpacing: 0.8, mb: 0.8,
                  ...
                  <TextField value={username} onChange={e => setUsername(e.target.value)} onKeyDown={handleKeyDown} placeholder="Enter your username" size="small" fullWidth autoFocus autoComplete="username" slotProps={{
            input: {
            ...
            letterSpacing: 0.8, mb: 0.8,
                  ...
                  <TextField type={showPass ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} onKeyDown={handleKeyDown} placeholder="Enter your password" size="small" fullWidth autoComplete="current-password" slotProps={{
            input: {
                startAdornment: (<InputAdornment position="start">
                ...
                endAdornment: (<InputAdornment position="end">
                            <IconButton size="small" onClick={() => setShowPass(p => !p)} edge="end" sx={{ color: alpha('#fff', 0.25), '&:hover': { color: alpha('#fff', 0.6) } }}>
                              {showPass
            ...
            '& input::placeholder': { color: alpha('#fff', 0.2), opacity: 1 },
                ...
                {/* Sign in button */}
                <Button variant="contained" fullWidth onClick={handleLogin} disabled={loading} endIcon={!loading && <ArrowForwardIcon sx={{ fontSize: 16 }}/>} sx={{
            mt: 0.5,
            borderRadius: '12px',
            fontFamily: '"Nunito", sans-serif',
            fontWeight: 800,
          ...
          <Box sx={{ textAlign: 'center', mt: 2 }}>
            <Chip label="Go to Teacher Login →" size="small" clickable onClick={() => navigate('/login')} sx={{
