    ...
    return (<>
      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          {/* Logo */}
          <Box component="img" src={logo} alt="CHILDTrack" sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
        ...
        ].map(({ label, active, to }) => (<Box key={label} component={active ? 'div' : Link} to={to ?? undefined} sx={{
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              <TextField label="Username *" fullWidth size="small" autoFocus value={username} onChange={e => setUsername(e.target.value)} sx={fieldSx} InputProps={{
            startAdornment: (<InputAdornment position="start">
                      <PersonOutlinedIcon sx={{ fontSize: 18, color: textSecondary }}/>
                    </InputAdornment>),
        }}/>
              <TextField label="Password *" type={showPw ? 'text' : 'password'} fullWidth size="small" value={password} onChange={e => setPassword(e.target.value)} sx={fieldSx} InputProps={{
            startAdornment: (<InputAdornment position="start">
